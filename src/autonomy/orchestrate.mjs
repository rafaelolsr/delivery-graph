...
export function orchestrateGoal({
  ...
  executor, decomposer, maxRounds = 3, threshold = 0.5, policy = {}, approvals = [], at = null
} = {}) {
  ...
  // 4. Run the governed self-reorganizing supervisor loop.
  const run = runSupervisor({
    goal: g, subgoals, org: org0, executor, strongerCandidates,
    maxRounds, threshold, policy, approvals, at
  });
